      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', "wrong password");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', "You could not log out");
...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(email, password, confirmPassword, name) {
    var response;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', "wrong user name or password");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/users/update-".concat(type === 'password' ? 'password' : 'data'),
              data: data
            });
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _stripeJs.loadStripe)('pk_test_51IutDVKOmYDhGqHeUf4vDtmelujGC8G5owq7nIkmCjZ4OsLSZgj24VW0wB5lsUAbFxe4UZmZUvzsp4fxmOizeGfu00P03F12Jt');

          case 2:
            stripe = _context.sent;
            _context.prev = 3;
            _context.next = 6;
            return (0, _axios.default)("/api/v1/booking/checkout/".concat(tourId));
...
},{"axios":"../../node_modules/axios/index.js","@stripe/stripe-js":"../../node_modules/@stripe/stripe-js/dist/stripe.esm.js","./alerts":"alerts.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    (0, _signup.signup)(email, password, confirmPassword, name);
  });
}
...
if (bookButton) {
  bookButton.addEventListener('click', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              e.target.textContent = 'Processing...'; //js automatically converts tour-id from data to tourId

              id = e.target.dataset.tourId;
              _context2.next = 4;
              return (0, _stripe.bookTour)(id);
